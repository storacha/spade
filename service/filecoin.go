...
// AuthorizationFilecoinClient defines the minimal Filecoin client interface
// required to support SP authorization.
type AuthorizationFilecoinClient interface {
...
// LookbackFilecoinClient defines the minimal Filecoin client interface
// required to support lookback tipset retrieval.
type LookbackFilecoinClient interface {
...
// ReservationFilecoinClient defines the minimal Filecoin client interface
// required to support reservation eligibility checks and related operations.
type ReservationFilecoinClient interface {
	LookbackFilecoinClient
	// MinerGetBaseInfo retrieves mining base info for a miner at a given tipset.
	MinerGetBaseInfo(context.Context, address.Address, abi.ChainEpoch, types.TipSetKey) (*api.MiningBaseInfo, error)
}

// SpadeFilecoinClient defines the minimal Filecoin client interface
// required to support all Spade service operations.
type SpadeFilecoinClient interface {
	AuthorizationFilecoinClient
	ReservationFilecoinClient
}
...
// [LookbackFilecoinClient].
func GetTipset(ctx context.Context, lapi LookbackFilecoinClient, lookback uint) (*fil.LotusTS, error) {
